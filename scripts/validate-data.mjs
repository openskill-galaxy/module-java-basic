...
console.log("\n--- Refs ---");
if(courses&&lessons){const cs=new Set(courses.map(c=>c.id));const ls=new Set(lessons.map(l=>l.courseId));[...ls].filter(x=>!cs.has(x)).length===0?o("lessons->courseIds OK"):f("orphan lessons");}
